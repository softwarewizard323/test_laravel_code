        ...
        <div class="row-fluid">
            <div class="widget widget-padding span12">
                <div class="widget-header">
                    <i class="icon-inbox"></i><h5>Open User Tickets</h5>
                    @if($user->username != 'piyushk61')
                        <a href="{{ url('/admin/support/archives') }}" class="btn btn-warning pull-right"
                           style="margin: 10px 15px 0 0;color:#FFF;">
                            <i class="icon-book"></i> View Archived Tickets
                        </a>
                    @endif
                </div>
                ...
                <div class="widget-footer">
                    ...
                    <div class="pull-right">
                        @if ($tickets)
                            <button class="btn" id="delete" type="submit" name="delete" value="Delete Selected Ticket"
                                    form="tickets"
