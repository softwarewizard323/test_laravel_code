			...
			<div class="widget widget-padding span9" id="wizard">
				<div class="wizard">
					<ul class="steps">
						...
						<li data-target="#step3" class="complete"><span class="badge badge-success">3</span>Step 3<span class="chevron"></span></li>
						<li data-target="#step4" class="active"><span class="badge badge-info">4</span>Step 4<span class="chevron"></span></li>
					</ul>
				</div>
				...
				<div class="widget-body" style="height:auto;overflow:auto;text-align:center;">
					...
					<div style="text-align:center;color:#666;margin:10px 0 25px 35px;padding-bottom:5px;border-bottom:solid 1px #DDD;" class="span11">
						...
						<p>Please wait for few seconds until our system processes your order.</p>
					</div>
					...
					<div class="messagePost" style="width:100%;margin-bottom:20px;color:#999;display:none;">
						Order added in your campaign list and waiting for moderator approval.
					</div>
					...
					<script>
						var progress = setInterval(function() {
							...
							if ($bar.width() >= 600) {
                                ...
                                window.location = "{{ url('/dashboard/booster/google') }}";
							} else {
